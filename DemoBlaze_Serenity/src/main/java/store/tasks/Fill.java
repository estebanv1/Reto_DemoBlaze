...
public class Fill implements Task{
    ...
    private final Logger LOGGER = LoggerFactory.getLogger(Fill.class);
    ...
    public <T extends Actor> void performAs(T actor) {
        LOGGER.info("Inicia el diligenciamiento de datos del usuario");
        actor.attemptsTo(
                ...
                WaitUntil.the(NAME_INPUT, isClickable()).forNoMoreThan(30).seconds().then(
                        Enter.theValue(userData.getUserName()).into(NAME_INPUT)),
        ...
        LOGGER.info("Se diligencian los datos del usuario");
    }
