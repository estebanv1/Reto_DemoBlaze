Feature: Make a purchase on demoblaze website
  ...
  Scenario Outline: Add two items to the shopping cart
    ...
    When he adds the items to the cart
      | name         | section         |
      | <firstItem>  | <firstSection>  |
      | <secondItem> | <secondSection> |
    And he sees the products in the shopping cart
      | name         | section         |
      | <firstItem>  | <firstSection>  |
      | <secondItem> | <secondSection> |
    And he completes the purchase form
      | userName   | country   | city   | creditCard   | month   | year   |
      | <userName> | <country> | <city> | <creditCard> | <month> | <year> |
  ...
  Examples:
    ...
    | firstItem         | firstSection  | secondItem          | secondSection | userName                                      | country   | city     | creditCard       | month   | year   |
